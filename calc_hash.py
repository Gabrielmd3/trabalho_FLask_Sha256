...
def limpar_diretorio_verificacao():
    ...
    arquivos = os.listdir('uploads_verificacao')
    
    # Percorre cada arquivo e remove-o
    for arquivo in arquivos:
        caminho_arquivo = os.path.join('uploads_verificacao', arquivo)
        os.remove(caminho_arquivo)

# Chamada da função para limpar o diretório após a validação
